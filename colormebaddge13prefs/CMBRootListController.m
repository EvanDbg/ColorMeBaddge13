...
- (id)init
{
	...
	{
		_audioPlayer = nil;
		_rubYouDownURL = [[NSURL alloc] initFileURLWithPath:@"/Library/PreferenceBundles/ColorMeBaddge13Prefs.bundle/ColorMeBaddgeRubYouDown.mp3"];
	}
...
//		initWithContentsOfFile:[[NSBundle bundleWithPath:@"/Library/PreferenceBundles/ColorMeBaddge13Prefs.bundle"] pathForResource:@"ColorMeBaddgeHeader" ofType:@"jpg"]] autorelease];
	UIImage *headerImage = [[UIImage alloc]
		initWithContentsOfFile:[[NSBundle bundleWithPath:@"/Library/PreferenceBundles/ColorMeBaddge13Prefs.bundle"] pathForResource:@"ColorMeBaddgeHeader" ofType:@"jpg"]];
